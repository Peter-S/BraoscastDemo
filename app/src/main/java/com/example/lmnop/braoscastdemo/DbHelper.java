package com.example.lmnop.braoscastdemo;
...
public class DbHelper extends SQLiteOpenHelper{
    ...
    public static final String CREATE = "create table " + DbContract.TABLE_NAME +
            "(id integer primary key autoincrement," + DbContract.INCOMING_NUMBER +
            " text);";
    ...
    public Cursor readNumber(SQLiteDatabase database) {
        ...
        return (database.query(DbContract.TABLE_NAME, projection, null,
                null, null, null, null));
    }
}
